...
this.NewCard.js = (function(React2, react) {
  ...
  hubspot.extend(({ context }) => /* @__PURE__ */ React2.createElement(FeeSheetCard, { context }));
  const BACKEND_ENDPOINT = "https://fee-sheet-backend.onrender.com/api/fee-sheet";
  const EXCEL_ICON_URL = "https://50802810.fs1.hubspotusercontent-na1.net/hubfs/50802810/File%20type%20icon.svg";
  ...
  function StatusTag({
    ...
    return /* @__PURE__ */ React2.createElement(Flex, { direction: "row", align: "center", gap: "xs" }, /* @__PURE__ */ React2.createElement(Image, { src: dotSrc, alt: "", width: 10 }), /* @__PURE__ */ React2.createElement(Text, { variant: "microcopy" }, label));
  }
  function FeeSheetCard({ context }) {
    var _a, _b, _c, _d, _e;
    const ctx = context;
    ...
    async function onCreate() {
      try {
        ...
        setStatus((body == null ? void 0 : body.message) || "Created.");
        await loadFeeSheetMeta();
      } catch (e) {
    ...
    async function onRefreshFromExcel() {
      try {
        ...
        setStatus((body == null ? void 0 : body.message) || "Synced.");
        await loadFeeSheetMeta();
      } catch (e) {
        setStatus(`Error: ${getErrorMessage(e)}`);
      }
    }
    async function onSyncToPandadoc() {
      return onRefreshFromExcel();
    }
    const actionDisabled = isLoading || isTogglingReady;
    return /* @__PURE__ */ React2.createElement(Flex, { direction: "column", gap: "sm" }, isLoading ? /* @__PURE__ */ React2.createElement(Text, { variant: "bodytext" }, "Loading fee sheet…") : !canOpen ? /* @__PURE__ */ React2.createElement(Button, { onClick: onCreate }, "Create Fee Sheet") : /* @__PURE__ */ React2.createElement(React2.Fragment, null, statusDisplay && /* @__PURE__ */ React2.createElement(StatusTag, { label: statusDisplay.label, tone: statusDisplay.tone }), /* @__PURE__ */ React2.createElement(Box, { flex: "initial" }, /* @__PURE__ */ React2.createElement(Flex, { direction: "row", align: "baseline", gap: "xs" }, /* @__PURE__ */ React2.createElement(Image, { src: EXCEL_ICON_URL, alt: "Excel", width: 32 }), /* @__PURE__ */ React2.createElement(
      Link,
      {
    ...
    ))), /* @__PURE__ */ React2.createElement(Flex, { direction: "column" }, /* @__PURE__ */ React2.createElement(Flex, { direction: "row", gap: "xs", align: "baseline" }, /* @__PURE__ */ React2.createElement(Text, { variant: "microcopy", format: { fontWeight: "bold" } }, proposalSentLocked ? "Marked ready:" : "Last updated:"), /* @__PURE__ */ React2.createElement(Text, { variant: "microcopy" }, proposalSentLocked ? relativeTime(readyAt || lastUpdatedAt) : relativeTime(lastUpdatedAt))), /* @__PURE__ */ React2.createElement(Flex, { direction: "row", gap: "xs", align: "baseline" }, /* @__PURE__ */ React2.createElement(Text, { variant: "microcopy", format: { fontWeight: "bold" } }, proposalSentLocked ? "Completed by:" : "Created by:"), /* @__PURE__ */ React2.createElement(Text, { variant: "microcopy" }, proposalSentLocked ? readyBy || "—" : feeSheetCreatedBy || "—"))), /* @__PURE__ */ React2.createElement(Divider, null), /* @__PURE__ */ React2.createElement(Flex, { direction: "column", gap: "xs" }, /* @__PURE__ */ React2.createElement(ButtonRow, null, !proposalSentLocked ? /* @__PURE__ */ React2.createElement(
      Button,
      {
        variant: "primary",
