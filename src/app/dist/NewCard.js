...
this.NewCard.js = (function(React2, react) {
  ...
  async function callBackend(params) {
    ...
    const res = await hubspot.fetch(url.toString(), {
      method: "GET",
      timeout: 15e3
    });
    if (!res.ok) {
  ...
  function FeeSheetCard({ context }) {
    ...
    const objectId = ((_a = context == null ? void 0 : context.crm) == null ? void 0 : _a.objectId) || ((_b = context == null ? void 0 : context.crm) == null ? void 0 : _b.recordId) || (context == null ? void 0 : context.objectId) || "";
    const createdByForRequest = React2.useMemo(() => {
      var _a2, _b2, _c;
      const first = ((_a2 = context == null ? void 0 : context.user) == null ? void 0 : _a2.firstName) || "";
      const last = ((_b2 = context == null ? void 0 : context.user) == null ? void 0 : _b2.lastName) || "";
      const full = `${first} ${last}`.trim();
      return full || ((_c = context == null ? void 0 : context.user) == null ? void 0 : _c.email) || "Unknown user";
    }, [context]);
    ...
    const computePhase1Status = () => {
      ...
      const hasSpTimes = spCreatedAt && spLastModifiedAt && !Number.isNaN(c.getTime()) && !Number.isNaN(m.getTime());
      if (hasSpTimes) {
        const diffMs = Math.abs(m.getTime() - c.getTime());
        const NOT_STARTED_THRESHOLD_MS = 60 * 1e3;
        if (diffMs <= NOT_STARTED_THRESHOLD_MS) {
          return { dot: "🔴", label: "not started" };
        }
        return { dot: "🟡", label: "in progress" };
      }
      if (lastUpdatedAt) return { dot: "🟡", label: "in progress" };
    ...
    React2.useEffect(() => {
      (async () => {
        try {
          ...
          setStatus(`Load error: ${(e == null ? void 0 : e.message) || String(e)}`);
        } finally {
          setIsLoading(false);
        }
      })();
    ...
    async function onCreate() {
      try {
        ...
        setStatus(`Error: ${(e == null ? void 0 : e.message) || String(e)}`);
      } finally {
        setIsLoading(false);
      }
    }
    const canOpen = typeof feeSheetUrl === "string" && feeSheetUrl.trim().startsWith("http");
    return /* @__PURE__ */ React2.createElement(Flex, { direction: "column", gap: "sm" }, isLoading ? /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(Text, { size: "sm" }, "Loading fee sheet…"), /* @__PURE__ */ React2.createElement(Button, { disabled: true }, "Loading…")) : canOpen ? /* @__PURE__ */ React2.createElement(React2.Fragment, null, pill ? /* @__PURE__ */ React2.createElement(Text, { size: "sm", format: { fontWeight: "bold" } }, pill.dot, " ", pill.label) : null, /* @__PURE__ */ React2.createElement(Link, { href: feeSheetUrl, openInNewTab: true }, /* @__PURE__ */ React2.createElement(
      Image,
      {
